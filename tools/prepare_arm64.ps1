...
function Main {
    ...
    &"lessmsi" "x" "$driveLetter\Installers\X64 Debuggers And Tools-x64_en-us.msi" `
               "c:\Programs Files (x86)\Windows Kits\10\Debuggers\x64\"  `
               "SourceDir\Windows Kits\10\Debuggers\x64\dbghelp.dll"
